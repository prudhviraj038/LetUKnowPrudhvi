...
public class ChannelsAdapter extends BaseAdapter implements Filterable {
    ...
    public ChannelsAdapter(Activity mainActivity, ArrayList<Chanel> chanels) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        holder.follow_btn=(TextView) rowView.findViewById(R.id.follow_btn);

        holder.follow_btn.setText(Html.fromHtml(db.is_following(chanels.get(position).ch_id) ? "Unfollow" : "Follow"));
        ...
        holder.follow_btn_click.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (db.is_following(chanels.get(position).ch_id)) {
                    ...
                    db.addPlaylist(chanels.get(position).ch_id, chanels.get(position).parent_id, "1");
                }
