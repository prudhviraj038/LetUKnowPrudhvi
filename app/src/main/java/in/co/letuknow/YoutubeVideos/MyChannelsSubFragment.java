...
public class MyChannelsSubFragment extends Fragment {


    RecyclerView recyclerView;
    public static MyChannelsSubFragment newInstance(int someInt) {
        MyChannelsSubFragment myFragment = new MyChannelsSubFragment();
